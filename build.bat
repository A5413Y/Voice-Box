...
@echo - The VoiceBox.exe file needs to have already been compliled with Autohotkey
@echo ========================================================================================
@echo.

@echo off
@set /p version="version: "
@set packageName=VoiceBox_v%version%
...
@robocopy "%PROJECT_DIR%" "Build\%packageName%" "VoiceBox.exe"
